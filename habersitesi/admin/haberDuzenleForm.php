...
<?php
    ...
    $haber = mysqli_fetch_array(mysqli_query($con, "SELECT * FROM haberler WHERE haber_id = $id"));
    ...
    if(!isset($haber)){
     ...
     if (isset($_POST['save'])) {
       ...
       $sa = mysqli_query($con,"UPDATE `haberler` SET `haber_basligi`=[$haberBasligi],`haber_icerigi`=[habericerigi],`haber_kategori`=[haberkategori] WHERE $id");
        if (!$sa) {
            echo "başarısız";
        } else {
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <form action="haberDuzenleForm.php" role="form">
                                        <div  class="form-group">
