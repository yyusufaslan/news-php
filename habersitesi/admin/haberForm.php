...
$habersor =mysqli_query($con,"select * from haberler");
                                    ...
                                    <form  method="post" role="form">
                                       ...
                                       ?>
                                        ...
                                        <div style="float: left;" class="form-group" >
                                             ...
                                             <button type="button" onclick="location.href='haberDuzenleForm.php?haber_id=<?php echo $habercek['haber_id']; ?>'" class="btn btn-default">D</button>
                                        </div>

                                         <div style="float: left;" class="form-group" >
                                             
                                             <label>Sil</label><br>
                                             <a type="submit" onclick="location.href='habersil.php?haber_id=<?php echo $habercek['haber_id']; ?>'" class="btn btn-default">S</a>
