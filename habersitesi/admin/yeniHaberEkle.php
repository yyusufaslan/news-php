...
if($_POST)
{
 if ($_FILES["resim"]["size"]<1024*1024){//Dosya boyutu 1Mb tan az olsun
    ...
    if (isset($_POST['yayinla'])) {
       ...
       $sa = mysqli_query($con,"INSERT INTO `haberler`(`haber_basligi`, `haber_icerigi`, `haber_kategori`,`haber_resmi`) VALUES ('$haberbasligi', '$habericerigi', '$haberkategori','$yeni_ad' )");
        if (!$sa) {
            echo "başarısız";
        } else {
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <form  method="post" role="form" action="yeniHaberEkle.php" enctype="multipart/form-data">
